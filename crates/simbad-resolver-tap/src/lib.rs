...
#[derive(Debug)]
pub struct SimbadTapResolver {
    client: reqwest::Client,
    endpoint: url::Url,
    timeout: Duration,
}

impl SimbadTapResolver {
...
#[async_trait]
impl Resolver for SimbadTapResolver {
...
#[async_trait]
impl PositionResolver for SimbadTapResolver {
...
mod tests {
    use super::*;
    use simbad_resolver_core::ObjectType;
